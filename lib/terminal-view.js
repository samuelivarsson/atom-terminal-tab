...
export default class TerminalView {
  ...
  constructor(session) {
    ...
    //this.session.view = this; TODO: Focus stuff...
  }

  // TODO: Fix focus function so that it switches to terminal window
  //       when inserting custom text
  // focus() {
  //   console.log("hej");
  ...
  applyTypeSettings() {
    ...
    //
    const fontFamily = atom.config.get('iv-terminal.fontFamily')
