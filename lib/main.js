...
export default {
  ...
  handleInsert1() {
    const customText = atom.config.get('terminal-tab.customTexts.customText1');
    handleCustomInsert(customText);
  },

  handleInsert2() {
    const customText = atom.config.get('terminal-tab.customTexts.customText2');
    handleCustomInsert(customText);
  },

  handleInsert3() {
    const customText = atom.config.get('iv-terminalcustomTexts.customText3');
    handleCustomInsert(customText);
  },
